...
<!-- ### FC -->
<!-- ```{r} -->
<!-- if (!file.exists("./output/fc_transcriptID.rds")) { -->
<!--   fc_te <- featureCounts( -->
<!--     isPairedEnd = TRUE, -->
<!--     files = bamFiles, -->
...
<!--     GTF.attrType.extra = c("gene_id", "family_id", "class_id"), -->
...
<!--   saveRDS(object = fc_te, file = "./output/fc_transcriptID.rds") -->
<!-- } else { -->
<!--   fc_te <- readRDS("output/fc_transcriptID.rds") -->
<!-- } -->

<!-- rownames(fc_te$annotation) <- fc_te$annotation$GeneID -->
<!-- counts_te <- SummarizedExperiment(list(counts = fc_te$counts)) -->
<!-- counts_te@metadata <- fc_te$annotation -->
<!-- ``` -->

...
tf_pos$Group <- gsub(pattern = "More accessible", replacement = "More accessible in adult spermatogonial cells", x = tf_pos$Group)
...
tf_neg$Group <- gsub(pattern = "Less accessible", replacement = "Less accessible in adult spermatogonial cells", x = tf_neg$Group)

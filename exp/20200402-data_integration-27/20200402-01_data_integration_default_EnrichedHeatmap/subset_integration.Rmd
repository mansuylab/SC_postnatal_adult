...
create_heatmap <- function(nc = 2) {
  ...
  if (!file.exists(pdf_file)) {
    ...
    if (nc == 1) {
      ht_list <- hm_atac + hm_chip + hm_bs + hm_rrbs
...
## Make heatmaps
```{r subset-integration-9, eval=FALSE}
mylapply(1:10, create_heatmap)
```
...
bsselectR::as_iframe(widget = bs, file = "v1.html")
```

...
if (!file.exists(nm_atac)) {
  ...
  counts_adult_AS <- regionCounts("input/atacseq/Adult_NF.bam",
    regions = tss_5k,
  ...
  adult_AS <- tss_5k
  adult_AS$Score <- assay(counts_adult_AS)[,1]
  
  mat_adult_AS <- normalizeToMatrix(adult_AS, tss_mm10,
    value_column = "Score",
    extend = 1000, mean_mode = "w0", w = 10, include_target = TRUE
  )
  ...
  # Reading counts from the peak regions
  counts_PND15_AS <- regionCounts("input/atacseq/PND15_NF.bam",
    regions = tss_5k,
    param = readParam(pe = "both"),
    BPPARAM = MulticoreParam(4)
  )
  ...
  pnd15_AS <- tss_5k
  pnd15_AS$Score <- assay(counts_PND15_AS)[,1]
...
if (!file.exists(nm_chip)) {
  ...
  counts_adult_CS_H3K27ac <- regionCounts("input/chipseq/PNW8_H3K27ac_SRX332351.bam",
    regions = tss_5k,
    param = readParam(pe = "both"),
    BPPARAM = MulticoreParam(4)
  )
  
  adult_CS_H3K27ac <- tss_5k
  adult_CS_H3K27ac$Score <- assay(counts_adult_CS_H3K27ac)[,1]
  ...
  counts_adult_CS_H3K27me3 <- regionCounts("input/chipseq/PNW8_H3K27me3_SRX332346.bam",
    regions = tss_5k,
    param = readParam(pe = "both"),
    BPPARAM = MulticoreParam(4)
  )
  
  adult_CS_H3K27me3 <- tss_5k
  adult_CS_H3K27me3$Score <- assay(counts_adult_CS_H3K27me3)[,1]
  ...
  counts_adult_CS_H3K4me3 <- regionCounts("input/chipseq/PNW8_H3K4me3_SRX332343.bam",
    regions = tss_5k,
    param = readParam(pe = "both"),
    BPPARAM = MulticoreParam(4)
  )
  
  adult_CS_H3K4me3 <- tss_5k
  adult_CS_H3K4me3$Score <- assay(counts_adult_CS_H3K4me3)[,1]
...
create_heatmap <- function(nc = 4) {
  ...
  if (!file.exists(pdf_file)) {
    ...
    ht_list <- hm_partition + hm_atac + hm_bs + hm_rrbs

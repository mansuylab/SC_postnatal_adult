...
## Make heatmaps
```{r integration-all-8}
mylapply(2:10, create_heatmap, mc.cores = 3)
# create_heatmap(nc = 2)
# create_heatmap(nc = 3)
# create_heatmap(nc = 4)
# create_heatmap(nc = 5)
...
# create_heatmap(nc = 8)
# create_heatmap(nc = 9)
# create_heatmap(nc = 10)
```

<!-- # Split on rows -->
<!-- This would be helpful in splitting the regions based on more or less accessible. -->

<!-- ## Sampling -->
<!-- ```{r} -->
<!-- EnrichedHeatmap(mat1, -->
<!--   name = "H3K4me3", -->
<!--   row_split = sample(c("A", "B"), length(genes), replace = TRUE), # sampling 2 groups -->

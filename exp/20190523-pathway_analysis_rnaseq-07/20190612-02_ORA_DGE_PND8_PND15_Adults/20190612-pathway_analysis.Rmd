...
pnd8.pnd15.DEA <- dea.limma$`PND8 vs PND15`
pnd8.pnd15.DEA <- merge(anno.s, dea.limma$`PND8 vs PND15`, by.x = "symbol", by.y = "Genes", all.y = T)
...
pnd8.pnd15.DEA$analysis <- "PND8 vs PND15"

pnd15.adult.DEA <- dea.limma$`PND15 vs Adult`
pnd15.adult.DEA <- merge(anno.s, dea.limma$`PND15 vs Adult`, by.x = "symbol", by.y = "Genes", all.y = T)
...
pnd15.adult.DEA$analysis <- "PND15 vs Adult"
```

# Pathway analysis
```{r}
mydf <- rbind(pnd8.pnd15.DEA[, c(2, 5, 9, 10)], pnd15.adult.DEA[, c(2, 5, 9, 10)])

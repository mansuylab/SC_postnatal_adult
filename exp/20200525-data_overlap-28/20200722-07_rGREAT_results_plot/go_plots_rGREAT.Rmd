---
title: "DO: GO plots from rGREAT"
author: "Deepak Tanwar"
date: "<b>Created on:</b> 2020-07-22 <br> <b>Updated on:</b> `r Sys.Date()`"
output:
...
# Results
```{r go-plots-rGREAT-2 }
files <- list.files(path = "input", pattern = "xlsx", full.names = T, recursive = T)
names(files) <- gsub(pattern = ".*/|.xlsx", replacement = "", x = files)
...
saveRDS(object = df, file = "df_GO_simplify.rds")
```

...
## Function
```{r 20191118-rGREAT-3}
perform_rGREAT <- function(df, FC, bg, fName, split = FALSE) {
  d <- NULL
...
## PND15
```{r 20191118-rGREAT-8, fig.width = 10, fig.height = 10/3, fig.align = 'center'}
plotRegionGeneAssociationGraphs(pnd15[[1]]$job)
```

## Adult
```{r 20191118-rGREAT-9, fig.width = 10, fig.height = 10/3, fig.align = 'center'}

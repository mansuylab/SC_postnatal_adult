...
all <- perform_rGREAT(df = da_f, FC = "all", bg = bg, fName = "PND15_Adult", split = F)
...
### Merging
```{r}
all_sp_m <- perform_rGREAT(
  df = da_f, FC = "all", bg = bg,
  fName = "PND15_Adult",
  split = T, sp_col = "anno1",
  split_bg = TRUE
)

pnd15_sp_m <- perform_rGREAT(
  df = da_f, FC = "neg",
  bg = bg, fName = "Adult_Negative",
  split = T, sp_col = "anno1",
  split_bg = TRUE

...
```{r}
counts.filt <- counts_filter(counts = salmon@tx.counts, nReads = 10)
```
...
save(data,
  file = "./output/data_pData_tx_lit.RData", compress = T,
  compression_level = 3
)
```
...
```{r}
save(dea.list,
  file = "./output/dea_SC_Controls_lit.DTE.RData", compress = T,
  compression_level = 3
)

save(normCounts,
  file = "./output/normCounts_voom_SC_Controls_lit_tx.RData", compress = T,
  compression_level = 3
)

save(voomEList,
  file = "./output/voom_EList_SC_Controls_lit_tx.RData", compress = T,
  compression_level = 3
)

save(dea.limma,
  file = "./output/limma_SC_Controls_lit_tx.RData", compress = T,
  compression_level = 3
)
```

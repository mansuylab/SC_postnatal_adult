...
tf_dea_pos$Group <- "More accessible in adult spg"

tf_dea_neg <- merge(tf_neg, dea)
tf_dea_neg$Group <- "Less accessible in adult spg"
...
tf_dea_sb_pos$Group <- "More accessible in adult spg"
...
tf_dea_sb_neg$Group <- "Less accessible in adult spg"
...
dg <- gridExtra::grid.arrange(egg::set_panel_size(p = d, width = unit(8, "cm"), height = unit(3.25, "cm")))

...
pos_tab <- pos_tab[order(pos_tab$NES, decreasing = T),][1:20,]
...
neg_tab <- neg_tab[order(neg_tab$NES),][1:20,]
...
cg <- gridExtra::grid.arrange(egg::set_panel_size(p = c, width = unit(3.5, "cm"), height = unit(9, "cm")))
...
dg <- gridExtra::grid.arrange(egg::set_panel_size(p = d, width = unit(3.5, "cm"), height = unit(9, "cm")))

...
tab$Significant[tab$Significant == "Negative"] <- "Less accessible in adult spg"
tab$Significant[tab$Significant == "Positive"] <- "More accessible in adult spg"
...
rd$Name[rd$Name == "Adult Positive"] <- "More accessible in adult spg"
rd$Name[rd$Name == "Adult Negative"] <- "Less accessible in adult spg"
...
bg <- gridExtra::grid.arrange(egg::set_panel_size(p = b, width = unit(2.65, "cm"), height = unit(6.37, "cm")))
...
go_df$Group[go_df$Group == "Adult Positive"] <- "More accessible in adult spg"
go_df$Group[go_df$Group == "Adult Negative"] <- "Less accessible in adult spg"
...
cg <- gridExtra::grid.arrange(egg::set_panel_size(p = c, width = unit(3.5, "cm"), height = unit(4, "cm")))
...
go_df_s$Group <- gsub(pattern = "Adult Positive", replacement = "More accessible in adult spg", x = go_df_s$Group)
go_df_s$Group <- gsub(pattern = "Adult Negative", replacement = "Less accessible in adult spg", x = go_df_s$Group)
...
subset(go_df_s, Group %in% c("More accessible in adult spg (TSS +/- 1kbp)", "More accessible in adult spg gene body")) -> go_df_s
go_df_s$Group <- gsub(pattern = "gene body", replacement = "(gene body)", x = go_df_s$Group)

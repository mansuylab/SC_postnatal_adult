...
rd$Name <- "More accessible in adult spermatogonia"
rd$Name[rd$logFC < 0] <- "Less accessible in adult spermatogonia"
...
c <- ggplot(data = rd, mapping = aes(x = anno, fill = anno)) +
  ...
  # coord_flip() +
  facet_wrap(~Name, nrow = 1, labeller = label_wrap_gen(width = 22)) +
  ggtitle("") +
  xlab("") +
...
c1 <- c + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
c2 <- c + theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))


cg <- gridExtra::grid.arrange(egg::set_panel_size(p = c, width = unit(4, "cm"), height = unit(4, "cm")))
cg1 <- gridExtra::grid.arrange(egg::set_panel_size(p = c1, width = unit(4, "cm"), height = unit(4, "cm")))
cg2 <- gridExtra::grid.arrange(egg::set_panel_size(p = c2, width = unit(4, "cm"), height = unit(4, "cm")))
...
ggsave(plot = cg1, filename = "output/c_no_grid.png", width = unit(8.5, "in"), height = unit(11, "in"), dpi = 320)
ggsave(plot = cg2, filename = "output/c_no_grid_no_axis.png", width = unit(8.5, "in"), height = unit(11, "in"), dpi = 320)
```
...
ta <- HeatmapAnnotation(
    ...
    show_annotation_name = TRUE,
    annotation_name_side = "right",
    annotation_name_rot = 0,show_legend = FALSE,
    annotation_name_gp = gpar(fontsize = 0, fontfamily = "Helvetica"),
    annotation_legend_param = list(
...
e1 <- Heatmap(
  ...
  column_title_gp = gpar(fontsize = 8.5, fontfamily = "Helvetica"),
  # column_title = NULL,
  ...
  heatmap_legend_param = list(
    title = expression(atop(Log[2]~CPM,(RNA-seq))),
...
e2 <- Heatmap(
  ...
  heatmap_legend_param = list(
    title = expression(atop(Log[2]~FC,(ATAC-seq))),
    at  =c(1, 1.5, 2),
    legend_height = unit(1, "cm"),
    title_position = "topleft",
    title_gp = gpar(fontsize = 10, fontfamily = "Helvetica"),
...
ht_opt$legend_gap <- unit(2, "mm")
ht_opt$legend_grid_height <- unit(2.8, "mm")
ht_opt$legend_grid_width <- unit(2.8, "mm")
...
right_annotation <- HeatmapAnnotation(
  ...
  annotation_name_gp = gpar(fontsize = 0, fontfamily = "Helvetica"),
  annotation_legend_param = list(
    title = expression(Log[2] ~ "FC (RNA-seq)"),
    title_gp = gpar(fontsize = 10, fontface = "plain", fontfamily = "Helvetica"),
    labels_gp = gpar(fontsize = 9, fontfamily = "Helvetica")
  )
)
...
b <- ha1 %v% Heatmap(
  ...
  height = unit(x = 6, units = "cm"), width = unit(x = 5, units = "cm"),
  heatmap_legend_param = list(
    title = expression(Log[2] ~ "FC (ATAC-seq)"),
    legend_height = unit(1, "cm"),
    at = c(-2, 0, 2),
    # title_position = "leftcenter-rot",
    title_gp = gpar(fontsize = 10, fontfamily = "Helvetica"),

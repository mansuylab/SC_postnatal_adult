---
title: "RNA-Seq: Heatmap of controls on all genes with FDR <= 0.05"
...
pheatmap(
  ...
  show_rownames = F, show_colnames = T, main = "SC controls all DGE FDR <= 0.05",
...
pheatmap(
  ...
  filename = "./output/20190514-SC_controls_all_DEG_fdr05.pdf"
)
```

...
## All samples
#samtools merge -@ 16 --write-index -O BAM -f ./output/pnd_adult.bam ./output/*.bam &&\
...
## PND15 samples
#samtools merge -@ 16 --write-index -O BAM -f ./output/pnd15.bam ./output/PND*.bam &&\
 samtools sort -m 8G -O BAM -@ 16 -o ./output/PND15.bam ./output/pnd15.bam &&\
 rm -rf ./output/pnd15.ba* &&\
 samtools index ./output/PND15.bam

## Adult samples
#samtools merge -@ 16 --write-index -O BAM -f ./output/adult.bam ./output/Adult*.bam &&\

...
ag <- gridExtra::grid.arrange(egg::set_panel_size(p = a, width = unit(5, "cm"), height = unit(7.39, "cm")))
ggsave(plot = ag, filename = "output/a.pdf", width = unit(16, "cm"), height = unit(8, "cm"), dpi = 320)
```
